...
-- 7. Средний вес роботов, округлив его до трех знаков после запятой
\echo '--- 7. Average weight ---'
  SELECT ROUND(AVG(weight), 3) AS avg_weight
    FROM jaegers;


-- 8. Увеличить на единицу количество уничтоженных kaiju у неразрушенных роботов
...
-- 9. Удалить уничтоженных роботов
