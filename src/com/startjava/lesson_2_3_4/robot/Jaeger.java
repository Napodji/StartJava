...
public class Jaeger {
    ...
    public void scanKaiju() {
        System.out.println("com.startjava.lesson_2_3.robot.Jaeger " + name + " сканирует местность в поисках кайдзю!");
    }

    public void attackKaiju() {
        System.out.println("com.startjava.lesson_2_3.robot.Jaeger " + name + " атакует кайдзю!");
    }
